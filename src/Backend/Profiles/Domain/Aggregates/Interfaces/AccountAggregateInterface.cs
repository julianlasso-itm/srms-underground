...
namespace Profiles.Domain.Aggregates.Interfaces
{
  ...
  {
    public Result<RegisterCountryDomainResponse> RegisterCountry(RegisterCountryDomainRequest request);
    ...
    public Result<RegisterProvinceDomainResponse> RegisterProvince(RegisterProvinceDomainRequest request);
