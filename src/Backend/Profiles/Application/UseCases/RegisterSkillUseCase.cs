...
{
    public class RegisterSkillUseCase<TEntity> : BaseUseCase<RegisterSkillCommand, RegisterSkillApplicationResponse, IPersonnelAggregateRoot> where TEntity: class
    {
        ...
        public RegisterSkillUseCase(IPersonnelAggregateRoot aggregateRoot, ISkillRepository<TEntity> skillRepository) : base(aggregateRoot)
        {
            _skillRepository = skillRepository;
        }

        public override async Task<RegisterSkillApplicationResponse> Handle(RegisterSkillCommand request)
        {
