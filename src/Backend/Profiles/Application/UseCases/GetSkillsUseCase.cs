...
{
	internal class GetSkillsUseCase<TSkillEntity>: BaseUseCase<GetSkillsCommand, GetSkillsApplicationResponse<TSkillEntity>, IPersonnelAggregateRoot> where TSkillEntity : class
	{
	   
		private readonly ISkillRepository<TSkillEntity> _skillRepository;

		public GetSkillsUseCase(IPersonnelAggregateRoot aggregateRoot, ISkillRepository<TSkillEntity> skillRepository): base(aggregateRoot)
		{
			_skillRepository = skillRepository;
		}

		public override async Task<GetSkillsApplicationResponse<TSkillEntity>> Handle(GetSkillsCommand request)
		{
