...
using ProtoBuf.Grpc;
using Shared.Infrastructure.ProtocolBuffers.QueryBank;
using Shared.Infrastructure.ProtocolBuffers.QueryBank.Requests;
using Shared.Infrastructure.ProtocolBuffers.QueryBank.Responses;
namespace QueryBank.Infrastructure.Services
{
    public class QueryBankService : IQueryBankServices
    {
